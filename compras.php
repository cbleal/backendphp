                        ...
                        ?>
                          ...
                          <tr>
                            ...
                            <td>
                              ...
                              <a class="btn btn-danger" href="compras.php?func=deleta&id=<?php echo $row['id'] ?>">
...
if (isset($_POST['btSalvar'])) {  
  ...
  $funcionario  = $_SESSION['nome_usuario'];
   ...
   $query  = "INSERT INTO compras (valor, produto, funcionario, data, status) 
              VALUES (
                      '{$valor}', 
                      '{$produto}',                      
                      '{$funcionario}',       
   ...
   $query_mov = "INSERT INTO 
    ...
    $query_pro = "UPDATE produtos SET valor_compra = '{$valor}' WHERE nome = '{$produto}'";	
    mysqli_query($conexao, $query_pro);
	 
	 	echo "<script type='text/javascript'>window.alert('Compra cadastrada com sucesso.')</script>";
    echo "<script type='text/javascript'>window.location='compras.php'</script>";

	 } else {
	 	echo "<script type='text/javascript'>window.alert('Erro ao cadastrar a Compra.')</script>";
    echo "<script type='text/javascript'>window.location='compras.php'</script>";
	 }         
...
if (@$_GET['func'] == 'deleta') {
  ...
  $funcionario = $_SESSION['nome_usuario'];
  // TABELA VENDAS
  $query = "UPDATE compras SET funcionario = '{$funcionario}', status = 'Cancelada' WHERE id = '{$id}' ";
  mysqli_query($conexao, $query);
  // TABELA MOVIMENTACOES
  $query = "DELETE FROM movimentacoes WHERE movimento = 'Compra' AND id_gasto = '{$id}' ";  
  mysqli_query($conexao, $query);
