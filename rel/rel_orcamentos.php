...
$query = "SELECT o.id, o.produto, o.serie, o.problema, o.laudo, o.valor_servico, o.pecas, o.valor_pecas, o.valor_total, o.data_geracao, c.nome as cli_nome, c.telefone, c.endereco, c.email, c.cpf, f.nome as func_nome FROM orcamentos o INNER JOIN clientes as c ON c.cpf = o.cliente INNER JOIN funcionarios as f ON f.id = o.tecnico WHERE o.id = '{$id}'";
...
<body>
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-sm-4">	
				<big> Data: <?php echo date('d/m/Y', strtotime($row['data_geracao'])); ?> </big>
			</div>
		</div>
		...
		<div class="row">
			...
			<div class="col-sm-3">	
				<p style="font-size:12px">  
					...
					<?php echo date('d/m/Y', strtotime("+5 days",strtotime($row['data_geracao']))); ?>						
				</p>
			</div>
		</div>
